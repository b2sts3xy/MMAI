        ...
        <section className='mobileWhitePapersContainer'>
            ...
            <div className='mobileBlockChain'>
                ...
                <div className='mobilePapers'>
                    <a href='https://doi.org/10.1049/cmu2.12465'><img className='mobilePapersimg' src='./imgWhitePaper/1-1.png'></img></a>
                ...
                <div className='mobilePapers'>
                    <a href='https://doi.org/10.1016/j.icte.2021.08.004'><img className='mobilePapersimg' src='./imgWhitePaper/1-2.png'></img></a>
            ...
            <div className='mobileMeaverse'>
                ...
                <div className='mobilePapers'>
                    <a href='https://doi.org/10.1049/itr2.12252'><img className='mobilePapersimg' src='./imgWhitePaper/2-1.png'></img></a>
                    <div className='mobilePaperMiniTitle'>Intelligent <br/>Transportation Systems</div>
                    <div id="mobileTHIHIS">THISIS</div>
                </div>
                <div className='mobilePapers'>
                    <a href='https://doi.org/10.48550/arXiv.2202.10336'><img className='mobilePapersimg' src='./imgWhitePaper/2-2.png'></img></a>
            ...
            <div className='mobileAI'>
                ...
                <div className='mobilePapers'>
                    <a href='https://doi.org/10.1109/JIOT.2022.3152929'><img className='mobilePapersimg' src='./imgWhitePaper/3-1.png'></img></a>
                    <div className='mobilePaperMiniTitle'>Low-power <br />and Lossy</div>
                    <div id="mobileTHIHIS">THISIS</div>
                </div>
                <div className='mobilePapers'>
                    <a href='https://doi.org/10.1109/JIOT.2020.3013272'><img className='mobilePapersimg' src='./imgWhitePaper/3-2.png'></img></a>
