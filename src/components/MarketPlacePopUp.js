            ...
            <div className={(popUpState) ? 'popup_container' : 'popup_container_none'}>
                <div className='popup_box'>
                    <div className='popup_link'>
                        <a href='https://nftworld.tcubemnet.com/' target="_blank" rel="noopener noreferrer" aria-label="Go MMAI MARKETPLACE"><img className='popup_linkImg' src='./img/pop_button.png' alt='Go MARKETPLACE Button' /></a>
                    </div>
                </div>
