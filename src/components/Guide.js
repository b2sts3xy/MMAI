    ...
    <div className='Window_Guide'>
        <div className='Guide'>
            ...
            <div className='Step1'>
                ...
                <div className='Step1_Address'>
                    <p>0xaa0c5b3567fd1bac8a2a11eb16c3f81a49eea90f</p>
                </div>
                <p>(Double-check Contract Address in
                    <u>Etherscan</u>
                    and
                    <u>Dextools</u>
                    to Avoid Scammers)</p>
            ...
            <div className='Step2'>
                ...
                <div className='Step2_url'>
                    <a href='https://uniswap.org/'>
                        <p>https://uniswap.org/</p>
                    </a>
                </div>
            ...
            width: "calc(100px + 20vw)"
                ...
                <div className='Step4'>
                    ...
                    <p><img
                        src='./assets/uniswapProcess4.webp'
                        style={{
