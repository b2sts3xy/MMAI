...
const MoreInfo = ({whatInfo, setInfoState}) => {
    ...
    const infos = {
        "world" : {
            imgs : [
                <img src='./images/imgInfo/world_1.webp' alt='MMAI MORE INFO'/>, <img src='./images/imgInfo/world_2.webp' alt='MMAI MORE INFO'/>, <img src='./images/imgInfo/world_3.webp' alt='MMAI MORE INFO'/>
            ],
        ...
        "wallet" : {
            imgs : [
                <img src='./images/imgInfo/wallet_1.webp' alt='MMAI MORE INFO'/>, <img src='./images/imgInfo/wallet_2.webp' alt='MMAI MORE INFO'/>, <img src='./images/imgInfo/wallet_3.webp' alt='MMAI MORE INFO'/>
            ],
        ...
        "games" : {
            imgs : [
                <img src='./images/imgInfo/games_1.webp' alt='MMAI MORE INFO'/>, <img src='./images/imgInfo/games_2.webp' alt='MMAI MORE INFO'/>, <img src='./images/imgInfo/games_3.webp' alt='MMAI MORE INFO'/>
            ],
    ...
    return (
        <div className='moreinfo_out' onClick={onCloseInfo}>
            <div className='moreinfo_container' onClick={(e) => e.stopPropagation()}>
                <div className='moreinfo_img'>
                    <div className='moreinfo_mainimg'>{infos[whatInfo].imgs[0]}</div>
                    <div className='moreinfo_subimg'>
                        {infos[whatInfo].imgs[1]}
                        {infos[whatInfo].imgs[2]}
                    </div>
                </div>
                <div className='moreinfo_text'>{infos[whatInfo].text}</div>
            </div>
        </div>
    );
};
